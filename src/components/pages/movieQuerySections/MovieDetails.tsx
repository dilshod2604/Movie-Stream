    ...
    >
      <div className="container">
        <div className="flex gap-x-8 pt-[50px] bg-black/75 p-5  max-md:flex-col">
          <div className="flex items-center justify-center w-[300px] h-[500px] rounded-md overflow-hidden max-md:w-full max-md:h-auto">
            <img
          ...
          <div className="flex flex-col gap-y-4">
            ...
            <div className="flex gap-x-4 items-center max-sm:flex-col max-md:items-start gap-y-3">

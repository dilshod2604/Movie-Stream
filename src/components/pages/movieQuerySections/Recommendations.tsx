"use client";
import { useGetRecommendationMoviesQuery } from "@/redux/api/movie";
...
const Recommendations = () => {
  ...
  const { data } = useGetRecommendationMoviesQuery(Number(movieId));

  return (
    <section className="w-full bg-gradient-to-t  from-transparent to-[#04152d85] pt-5">
      <div className="container">
        <div className="flex flex-col items-start gap-y-5">
          <h1 className="text-white  font-bold text-2xl ">Recommendations</h1>

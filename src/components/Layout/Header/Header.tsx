      ...
      <div className="container">
        <div className="flex justify-between">
          <div className="flex items-center " onClick={()=>router.push("/")}>
            <h1 className="text-white font-bold text-3xl">𝓜𝓸𝓿𝓲𝓮 </h1>
            <div className=" flex items-center justify-center overflow-hidden w-[50px] h-[50px] ">
              <Image src={logo} alt="logo" />
            </div>
            <h1 className="text-white font-bold text-3xl">𝓢𝓽𝓻𝓮𝓪𝓶</h1>
          </div>
          ...
          {
            isOpen&&<Modal isOpen={isOpen} className="top-[80px] right-0">
            <BurgerMenu />
          </Modal>
          }
